...
public class PrimedTNTX1000Renderer extends MobRenderer<PrimedTNTX1000Entity, ModelTNT<PrimedTNTX1000Entity>> {
	public PrimedTNTX1000Renderer(EntityRendererProvider.Context context) {
		super(context, new ModelTNT(context.bakeLayer(ModelTNT.LAYER_LOCATION)), 0.5f);
	}

	@Override
	public ResourceLocation getTextureLocation(PrimedTNTX1000Entity entity) {
